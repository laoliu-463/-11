...
14. **一台机器有 5 个中断源（1、2、3、4、5），硬件固有优先级为 1>2>3>4>5。现在希望通过软件掩码重新排出响应顺序 4>3>5>1>2。请：**
    **A machine has 5 interrupt sources (1, 2, 3, 4, 5) with hardware priority 1>2>3>4>5. Now we want to rearrange the response order to 4>3>5>1>2 using software masks. Please:**
    ...
    > **所属模块**: 模块四：I/O 系统 (Input/Output System)
>
> **解析 (Explanation)**: （1）掩码字 (Mask Words) | 中断源 (Source) | 目标顺序 (Target Order) | 掩码字 (Mask 1->5) | 说明 (Note) | |---|---|---|---| | 4 | 1st | `1 1 1 0 0` | 屏蔽 1,2,3 (Mask 1,2,3) | | 3 | 2nd | `1 1 0 1 1` | 屏蔽 1,2,4,5 (Mask 1,2,4,5) | | 5 | 3rd | `1 1 1 1 0` | 屏蔽 1,2,3,4 (Mask 1,2,3,4) | | 1 | 4th | `0 1 1 1 1` | 屏蔽 2,3,4,5 (Mask 2,3,4,5) | | 2 | 5th | `1 0 1 1 1` | 屏蔽 1,3,4,5 (Mask 1,3,4,5) | （2）时间轴 (Timeline) 0-10: 主程序 (Main Program) 10-25: **ISR 4** (I4 响应 / I4 serviced) 25-40: **ISR 3** (I3 响应 / I3 serviced) 40-55: **ISR 5** (I5 响应 / I5 serviced) 55-70: **ISR 1** (I1 响应 / I1 serviced) 70-85: **ISR 2** (I2 响应 / I2 serviced) 85+: 主程序 (Main Program)
>
