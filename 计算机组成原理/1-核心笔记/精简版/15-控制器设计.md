...
graph TD
    ...
    %% 定义关系节点样式 (菱形)
    classDef relationship fill:#FFF9C4,stroke:#FBC02D,stroke-width:2px,color:#000;
    %% 定义关系属性节点样式 (椭圆/圆角虚线框)
    classDef relAttribute fill:#FFFFFF,stroke:#757575,stroke-width:1px,stroke-dasharray: 5 5,rx:15,ry:15,color:#000;
    ...
    %% =================== 关系 (Relationship) ===================
    Hire{聘用}:::relationship
    Sale{销售}:::relationship
    Contain{包含}:::relationship

    %% =================== 关系属性 (Relationship Attribute) ===================
    %% 使用圆角节点表示附着在关系上的属性
    HireAttr(聘期, 月薪):::relAttribute
    SaleAttr(销售量):::relAttribute

    %% =================== 连接与基数 (Connections & Cardinality) ===================
