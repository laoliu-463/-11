...
### 📝 代码文件说明
- **[Tree.java](../代码练习/05-树和二叉树/Tree.java)** - 一般树（多叉树）完整实现
- **[BinaryTree.java](../代码练习/05-树和二叉树/BinaryTree.java)** - 二叉树完整实现
- **[TreeToBinaryTree.java](../代码练习/05-树和二叉树/TreeToBinaryTree.java)** - 树与二叉树转换实现
- **[BinarySearchTree.java](../代码练习/05-树和二叉树/BinarySearchTree.java)** - 二叉排序树（BST）完整实现
- **[AVLTree.java](../代码练习/05-树和二叉树/AVLTree.java)** - AVL树（平衡二叉树）完整实现
...
// 孩子链表节点
class ChildNode {
    int index;           // 子节点在数组中的索引
    ChildNode next;      // 下一个子节点
}

// 表头节点
class HeadNode {
    int data;            // 数据域
    ChildNode firstChild; // 第一个子节点指针
}
...
class CSNode {
    int data;        // 数据域
    CSNode firstChild;  // 左指针：指向第一个子节点
    CSNode nextSibling; // 右指针：指向右兄弟节点
}
```
...
class TreeNode {
    ...
    TreeNode left;      // 左指针：指向左子节点
    TreeNode right;     // 右指针：指向右子节点
    TreeNode parent;    // 父指针：指向父节点（根节点为null）
...
class ThreadedTreeNode {
    int data;                    // 数据域
    ThreadedTreeNode left;       // 左指针
    ThreadedTreeNode right;      // 右指针
    boolean leftTag;            // 左标志：false表示左子节点，true表示前驱
    boolean rightTag;           // 右标志：false表示右子节点，true表示后继
    
    ThreadedTreeNode(int data) {
        this.data = data;
        this.left = null;
        this.right = null;
        this.leftTag = false;
...
public void preOrder(TreeNode node) {
    ...
    System.out.print(node.data + " ");  // 1. 访问根节点
...
public void inOrder(TreeNode node) {
    ...
    System.out.print(node.data + " ");   // 2. 访问根节点
...
public void postOrder(TreeNode node) {
    ...
    System.out.print(node.data + " ");   // 3. 访问根节点
}
```
...
**代码参考：** [树与二叉树转换完整实现](../代码练习/05-树和二叉树/TreeToBinaryTree.java)
...
**代码参考：** [二叉排序树完整实现](../代码练习/05-树和二叉树/BinarySearchTree.java)
...
**代码参考：** [AVL树完整实现](../代码练习/05-树和二叉树/AVLTree.java)
...
**代码参考**：
- [一般树（多叉树）完整实现](../代码练习/05-树和二叉树/Tree.java)
- [二叉树完整实现](../代码练习/05-树和二叉树/BinaryTree.java)
- [树与二叉树转换实现](../代码练习/05-树和二叉树/TreeToBinaryTree.java)
- [二叉排序树（BST）完整实现](../代码练习/05-树和二叉树/BinarySearchTree.java)
- [AVL树（平衡二叉树）完整实现](../代码练习/05-树和二叉树/AVLTree.java)
- [红黑树完整实现](../代码练习/05-树和二叉树/RedBlackTree.java)
